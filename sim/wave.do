...
#   All traces are drawn in the same green for a uniform look.
# ============================================================================
...
add wave -color green -hex sim:/tb_top/intf/AWID sim:/tb_top/intf/AWADDR sim:/tb_top/intf/AWLEN
...
add wave -color green sim:/tb_top/intf/AWVALID sim:/tb_top/intf/AWREADY

add wave -divider {W Channel}
add wave -color green -hex sim:/tb_top/intf/WDATA sim:/tb_top/intf/WSTRB
add wave -color green sim:/tb_top/intf/WLAST sim:/tb_top/intf/WVALID sim:/tb_top/intf/WREADY
...
add wave -color green sim:/tb_top/intf/BVALID sim:/tb_top/intf/BREADY

add wave -divider {AR Channel}
add wave -color green -hex sim:/tb_top/intf/ARID sim:/tb_top/intf/ARADDR sim:/tb_top/intf/ARLEN
...
add wave -color green sim:/tb_top/intf/ARVALID sim:/tb_top/intf/ARREADY

add wave -divider {R Channel}
add wave -color green -hex sim:/tb_top/intf/RID sim:/tb_top/intf/RDATA
add wave -color green -radix axi4_resp sim:/tb_top/intf/RRESP
add wave -color green sim:/tb_top/intf/RLAST sim:/tb_top/intf/RVALID sim:/tb_top/intf/RREADY
