...
//               responses out-of-order (RID order != ARID order). The default slave emits
//               a whole burst at a time; the receiver nevertheless supports
//               legal cross-ID read-data interleaving.
